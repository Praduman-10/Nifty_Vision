...
.panel{background:linear-gradient(145deg,#0d1012,#090b0d);border:1px solid #252b31;border-radius:16px;padding:17px;margin-bottom:12px;box-shadow:0 8px 25px rgba(0,0,0,.13)}.panel-head{display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid #1d2328;padding-bottom:11px;margin-bottom:13px}.pt{font-size:.76rem;font-weight:1000;letter-spacing:1.8px;text-transform:uppercase;color:#ffffff}.pattern-card{padding:10px 11px;border:1px solid #20262c;border-radius:10px;background:#0a0c0e;margin-bottom:8px}.pattern-card.bull{border-left:3px solid #00e676}.pattern-card.bear{border-left:3px solid #ff5252}.pattern-card.neutral{border-left:3px solid #ffc107}.pattern-name{font-size:.72rem;font-weight:900;letter-spacing:.4px}.pattern-meta{font-size:.58rem;color:#77818b;margin-top:3px}.pattern-meaning{font-size:.67rem;color:#aab2ba;margin-top:5px;line-height:1.4}.divider{height:1px;background:#20252a;margin:18px 0}.read{font-size:.72rem;color:#999;line-height:1.5}
